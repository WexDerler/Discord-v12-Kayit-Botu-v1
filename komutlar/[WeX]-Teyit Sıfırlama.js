...
//[WeX]-Tetiyleri Sıfırlayabilecek olan Yetkili ID'leri Yetkili ID'lerini arttırmak için ["ıd", "ıd",] ("",) yazarak çoğaltabilirsiniz.
...
message.channel.send(new Discord.MessageEmbed().setAuthor(`Kayıt Sıfırlandı`).setColor("0x2f3136").setDescription(`${member} Adlı kullanıcının Data'sında kayıtlı olan Teyit verileri silindi, <@${message.author.id}> karafından sıfırlandı.`))
